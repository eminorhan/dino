...
srun python -u /scratch/eo41/dino/eval_linear_wds.py \
	...
	--num_workers 1 \
	--lr 0.0005 \
	--output_dir "/scratch/eo41/dino/evals/konkle_objects" \
	--train_data_path "/scratch/eo41/data/konkle_objects/konkle_objects_train_000000.tar" \
	--val_data_path "/scratch/eo41/data/konkle_objects/konkle_objects_val_000000.tar" \
	--n_train 2020 \
	--n_val 2020 \
	--num_labels 240
