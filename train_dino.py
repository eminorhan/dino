...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--arch', default='vit_small', type=str, choices=['vit_small', 'vit_base', 'vit_large', 'vimlp_huge'] + torchvision_archs, help="""Name of architecture to train.""")
