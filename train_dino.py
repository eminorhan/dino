...
def get_args_parser():
    ...
    parser.add_argument('--arch', default='vit_small', type=str,
        choices=['vit_tiny', 'vit_small', 'vit_base', 'vit_large', 'deit_tiny', 'deit_small'] + torchvision_archs,
    ...
    parser.add_argument('--print_freq', default=5000, type=int, help='Print progress every x iterations.')
...
def train_one_epoch(student, teacher, teacher_without_ddp, dino_loss, data_loader, optimizer, lr_schedule, wd_schedule, momentum_schedule, epoch, fp16_scaler, args):
    ...
    for _, images in enumerate(data_loader):
        ...
        with torch.no_grad():
            m = momentum_schedule[GLOBAL_ITER // 2]  # momentum parameter
