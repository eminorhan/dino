...
#SBATCH --mem=480GB
#SBATCH --time=0:05:00
#SBATCH --job-name=train_dino_vimlps_liaon2b_fsdp
#SBATCH --output=train_dino_vimlps_liaon2b_fsdp_%A_%a.out
#SBATCH --array=0
...
# vimlp_huge
srun python -u /scratch/eo41/dino/train_dino_fsdp.py \
	--use_fp16 true \
	--arch "vimlp_huge" \
